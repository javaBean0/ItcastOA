...
public class Installer {
    ...
    public void install(){
        ...
        session.save(new Privilege("岗位编辑", "roleAction_edit", null, menu1));
        ...
        session.save(new Privilege("部门编辑", "departmentAction_edit", null, menu2));
        ...
        session.save(new Privilege("用户编辑", "userAction_edit", null, menu3));
        ...
        menu2 =new Privilege("申请模块管理", "applicationTemplateAction_list", null, menu);
